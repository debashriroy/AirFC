...
print("Shape of the model inputs: ", model_inputs[input_keys[3]].shape, model_inputs[input_keys[4]].shape, model_inputs[input_keys[5]].shape, model_inputs[input_keys[6]].shape)
